        ...
        <div className="section-wrapper">
          <div className="section">
            ...
            <div className="postings-btn-wrapper">
              <a href="https://forms.gle/wnhivgwe4tdrDZJL6" target="_default" className="btn btn-success interested-btn">I'm Interested</a>
              <a href="https://forms.gle/BF9YtTy1rpLyuNZB9" target="_default" className="btn not-interested-btn">Not Interested</a>
            </div>
          </div>
        </div>
        <div className="section-wrapper">
          <div className="section">
            ...
            <div><br /></div>
            <div>The mission of GO-FOOD as a product is to provide it’s customers with the best possible selection of food at the most affordable price. GO-FOOD is also a market place for restaurants to list their food items and increase their sales. GO-FOOD also has it’s own fleet of drivers with an app where they can accept food orders and earn their daily income out food delivery. So overall it’s an ecosystem consisting of consumers, merchants and drivers which GO-FOOD manages with the ultimate aim of providing best user experience to consumers and growth for merchants and drivers.</div>
            <div><br /></div>
            <div><b>What we have?</b></div>
            <div>We currently have a team of 40+ engineers across 2 different locations Bangalore and Jakarta. GO-FOOD being one of the largest online food delivery applications, the scale at which this team operates is phenomenal. GO-FOOD has more than 300k merchants and more than 20 millions dishes listed on it’s platform.</div>
            <div><br /></div>
            ...
            <div>
              ...
              <ul className="posting-requirements plain-list">
                <ul>
                  ...
                  <li>Design and develop highly scalable, reliable and fault tolerant systems for one of the world's fastest growing unicorns.</li>
                  <li>Communicate, collaborate and work effectively across distributed teams in a global environment.</li>
                  <li>You greatly value humility.</li>
                  <li>You shall write code because you like to. You never stop wanting to get better at it.</li>
                </ul>
              </ul>
            </div>
          </div>
            ...
            <div>
              ...
              <ul>
                <ul>
                  ...
                  <li>Data modelling experience in both Relational and NoSQL databases.</li>
                  <li>Have hands on experience with ElasticSearch.</li>
                  <li>Ability to design and implement low latency RESTful services.</li>
                  <li>Continuously refactor applications and architectures to maintain high quality levels.</li>
                  <li>Experience in troubleshooting server performance &shy;memory issues, GC tuning, resource leaks etc.</li>
                  <li>Prior experience of product based startups is a plus.</li>
                  <li>Passion for learning new things, solving challenging problems.</li>
                </ul>
              </ul>
            </div>
          </div>
          ...
          <div className="section text-center">
            <div className="postings-btn-wrapper">
              <a className="btn btn-success interested-btn" href="https://forms.gle/wnhivgwe4tdrDZJL6" target="_default">I'm Interested</a>
              <a className="btn not-interested-btn" href="https://forms.gle/BF9YtTy1rpLyuNZB9" target="_default">Not Interested</a>
            </div>
          </div>
        </div>
      </div>
