    ...
    render() {
        return (
            <section className="first-section pt-3">
                <Helmet>
                    <title>Backed by GOJEK, GO-VIET launches its services in Vietnam</title>
					<meta property="og:title" content="Backed by GOJEK, GO-VIET launches its services in Vietnam" />
					<meta name="twitter:title" content="Backed by GOJEK, GO-VIET launches its services in Vietnam" />
                    <meta name="description" content="Owing to the great success of GOJEK in Indonesia, GO-VIET will try and replicate the same in Vietnam." />
                    <meta name="twitter:description" content="Owing to the great success of GOJEK in Indonesia, GO-VIET will try and replicate the same in Vietnam." />
                    <meta property="og:description" content="Owing to the great success of GOJEK in Indonesia, GO-VIET will try and replicate the same in Vietnam." />
                </Helmet>
                    ...
                    <div className="row">
                        ...
                        <div className="px-4 px-md-0 font-xs-l roboto-regular">
                            ...
                            <ul className="pt-5">
                                ...
                                <li className="text-dark">The GO-VIET app was developed using cutting edge GOJEK technology</li>
                            ...
                            <p className="pt-4">
                                GO-VIET, the on-demand multi-service app backed by GOJEK, is set to expand its coverage to 12 districts across Ho Chi Minh City on Wednesday, August 1st, as the app becomes available for public download on the Apple App Store & Google Play for the first time.
                            </p>
                            <p>
