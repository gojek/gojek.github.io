    ...
    return (
      <div className="col-md-4 col-lg-3  col-6 text-center mt-4 mb-0 px-1 ">
        <div
          ...
          className={` scroll careers-position careers-position-unhighlight d-flex flex-column flex-wrap justify-content-center align-items-center ${
            this.props.id === this.props.positionId ? '  border-success ' : ''
          }`}
          id={this.props.id}
          name={this.props.id}
        ...
        >
          {
            <h6 className=" px-4 roboto-regular font-sm  pt-3">
              {this.props.heading}
            </h6>
          }
