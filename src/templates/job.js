...
class PostTemplate extends React.Component {
  ...
  render() {
    const jobsJson =
      this.props.data !== undefined ? this.props.data.jobsJson : ''
              ...
              <div className="tab-content" id="myTabContent">
                ...
                {jobsJson.jobId === 'fk0juf6' && (
                  <div
                    ...
                    id={`platformSpecificRequirements`}
                    role="tabpanel"
                    aria-labelledby={`platformSpecificRequirements-tab`}
                  >
                    <section className="roboto-regular">
                      <div className="container">
                        <div className="row justify-content-center">
                                ...
                                <div className="row">
                                  <div className="col-md-6 col-sm-12  pr-5">
                                    <li className="py-2 font-md">
                                      <span className="font-sm text-dark">
                                        ...
                                        and the history and design principles
                                        behind it
                                      </span>
                                    </li>
                                  </div>
                                  ...
                                  <div className="col-md-6 col-sm-12  pr-5">
                                    <li className="py-2 font-md">
                                      <span className="font-sm text-dark">
                                        {' '}
                                        Deep knowledge of Android UI
                                        fundamentals and experience with
                                        graphics APIs (Canvas, Paint,
                                        PorterDuffModes etc)
                                      </span>
                                    </li>
                                  </div>
                              ...
                              <ul className="text-green">
                                <div className="row">
                                  ...
                                  <div className="col-md-6 col-sm-12  pr-5">
                                    <li className="py-2 font-md">
                                      <span className="font-sm text-dark">
                                        Ability to develop UIs programatically
                                        or via XIB
                                      </span>
                                    </li>
                                  </div>
                              ...
                              <ul className="text-green">
                                <div className="row">
                                  ...
                                  <div className="col-md-6 col-sm-12  pr-5">
                                    <li className="py-2 font-md">
                                      <span className="font-sm text-dark">
                                        Autodidact capable of learning slow
                                        and/or fast
                                      </span>
                                    </li>
                                  </div>
                                  ...
                                  <div className="col-md-6 col-sm-12  pr-5">
                                    <li className="py-2 font-md">
                                      <span className="font-sm text-dark">
                                        Extremely well versed with the
                                        JavaScript language in general along
                                        with transpiling tools like Babel,
